      ...
      <div>
        ...
        <div className="collection-item avatar">
          <p className="email-subject truncate">
            ...
            <a href="#modal2" className="secondary-content modal-trigger"
              onClick={(event) => {
                event.preventDefault();
        ...
        <div id="message-board" className="email-content-wrap">
          <div className="row">
            ...
            <div className="col s2 m2 l2 email-actions">
              <a href="#!">
                <span>
                  <i className="mdi-content-reply"></i>
                </span>
              </a>
              <a href="#!">
                <span>
                    ...
                    {this.state.groupId ?
                      (
                        <div>
                          ...
                          <div id="message-board" c
                            lassName="email-content-wrap">
                            <div className="row">
                              <div className="col s10 m10 l10">
                                <ul className="collection">
                                  {/** single message **/}
...
export default connect(mapStateToProps,
  { getGroups, createGroup, getMessages, createMessage })(Dashboard);